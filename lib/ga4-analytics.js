...
function formatPagePath(path) {
  var map = {
    "/": "메인",
    "/index.html": "메인",
    "/company/greeting.html": "인사말",
    "/company/philosophy.html": "경영방침",
    "/company/organization.html": "조직도",
    "/company/certification.html": "인증현황",
    "/company/location.html": "찾아오시는길",
    "/business/facility.html": "시설관리",
    "/business/cleaning.html": "미화·방역관리",
    "/business/security.html": "보안·주차관리",
    "/business/hotel.html": "호텔관리",
    "/business/staffing.html": "인재파견",
    "/portfolio/index.html": "관리실적",
    "/portfolio/": "관리실적",
    "/notice/index.html": "공지사항",
    "/notice/": "공지사항",
    "/notice/view.html": "공지 상세",
    "/notice/recruit.html": "채용현황",
    "/notice/recruit/": "채용현황",
    "/notice/recruit/view.html": "채용 상세",
...
function formatChannel(name) {
  const map = {
    ...
    "google": "Google 검색",
    "naver": "Naver 검색",
    "m.search.naver.com": "Naver 검색(모바일)",
...
async function fetchAnalytics(options) {
  ...
  return {
    ...
    pages: ((pageRes[0] && pageRes[0].rows) || []).map(function (row) {
      var path = dimValue(row, 0);
      return {
        path: path,
        label: formatPagePath(path),
